...
subtitle: "Presented at the Sydney Environment Institute Lunchtime Seminar Series"
...
# Dec 2023 - Feb 2024 forecasts (relative to 1991-2020)

.left-40[
![](figures/DJF24_Afr_pcp.gif)
]

.right-40[
![](figures/DJF24_Afr_tmp.gif)
]
...
In locations with crop agriculture during the early postharvest season. 

**A 1&deg;C increase in the December Oceanic Niño Index (ONI)&mdash;typically indicative of a moderate El Niño event&mdash;is associated with at least three percent reduction in political violence with civilian targeting during the three-months period after harvest (evaluated at average cropland size and average crop growing season intensity of ENSO teleconnections).**

---


# Anecdotal evidence: Late 19th century El Niño events
...
In Ethiopia, 'The Great Famine of 1888-92' was likely triggered (or, at least, partly aided) by El Niño events that brought about droughts. 
...
- Like Dutch colonialists in Indonesia, Italian invaders in Ethiopia used the pretext of abandoned lands to pave the way for the colonization of the Eritrean highlands and the Tigray plateau (Davis, 2002).
...
Resentment, as farmers and non-farmers assess their well-being relative to the expectations or to the well-being of others, can amplify political violence ([Mitra and Ray, 2014](https://doi.org/10.1086/676316); [Hendrix and Haggard, 2015](https://doi.org/10.1177/00223433145615)).
...
# Political violence over time and across space
...
A 1&deg;C increase in growing-season-adjusted December ONI **reduces** political violence by $3.6\%$ during the postharvest season. This effect is relative to the observed average incidents conflict in croplands (0.04) evaluated at the average cropland size (9,000 hectares) and the average teleconnection intensity (0.28).
...
In a subset of countries where most of the cropland is characterized by a simultaneous decrease in average growing season precipitation and increase in average growing season maximum temperature in response to a positive deviation in December ONI:

A 1&deg;C increase in growing-season-adjusted December ONI **reduces** political violence by $4.6\%$ during the postharvest season. 

In the rest of the countries the effect is smaller and not significant.
...
A 1&deg;C increase in growing-season-adjusted December ONI **reduces** political violence by $6.7\%$ during the postharvest season. 
...
This accords with recent literature on the positive relationship between agricultural output and conflict (e.g., [McGuirk and Burke 2020](https://doi.org/10.1086/709993); [Koren and Schon 2023](https://link.springer.com/article/10.1007/s10113-023-02090-7)) and contributes to the emerging literature on the seasonality of conflict (Guardado and Pennings 2023; [Ubilava et al. 2023](https://doi.org/10.1111/ajae.12364)).
...
**Because we can predict ENSO events at least several months in advance**, the estimated linkages between ENSO shocks and conflict can have clear policy implications in establishing an early-warning system for political violence in ENSO-affected regions of Africa.

**Because ENSO events can simultaneously alter several weather variables**, including extreme weather events, across large swathes of land, the ENSO effect can be viewed as a better approximation of the effect of changing climate on societal outcomes
