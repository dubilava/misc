...
- This presentation is about presenting an academic work.
- It is also about presenting the said talk to academics.
- This is not the presentation formula. 
- Rather, this is a formula for a presentation.
- Depending on research, and target audience, the structure and composition of a presentation will and should vary.
- The motive and the general principles of a presentation will remain more or less the same.
- And that's what is what this presentation is about.

---


# The value a good presentation

- A research project usually culminates in a publication.
- Along the way, typically once the complete draft of the paper is ready, the author(s) present the study to the interested parties, usually to other academics.
- When done skillfully, a presentation can play a decisive role in the ultimate success of the paper, measured by the quality of the journal it will end up published, or the number of citations it receives. 

---

# The value a good presentation

- There is value in giving a good presentation. 
- Preparing a good presentation is half the battle.
...
- The proportions and composition of different bits an pieces of the paper change somewhat as we map a paper onto a presentation. 
...
- It is important in papers, and more so in presentations, to get to the point of she study early.
- In the paper:
  * state the research question on the first page.
- In the presentation:
  * state the research question on the first slide. 
  * offer the 'answer' to the question&mdash;the takeaway message of the study on the next slide.
- When done in this way, the message will stick with the audience throughout the presentation.
...
- The word-count on a slide is not the number of words that appear on it, it's the number of words the presenter says while on that slide.
...
- In the paper:
  ...
  * a table, also, should be self-contained.
- In the presentation:
...
- In the paper:
  * explain every detail of the equation, every bit of its Greek and Latin characters.
- In the presentation:
  * provide enough detail, refer the audience to the paper.
...
- You just happen to know the most about the topic&mdash;because it is *your* topic&mdash;and, thus, you are the one leading the conversation.
...
- Enjoyable for you as well as for your audience.
...
The content and inspiration of these slides are based on these excellent sources:
