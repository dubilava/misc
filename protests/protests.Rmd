...
subtitle: "Presented at the ADEW2025 on 6 June 2025"
...
# Agrarian diversity amplifies social unrest
...
| Conflict type        | Unrest     | Protests   | Riots      |
|:-------------------- | ----------:| ----------:| ----------:|
| price                | -0.372\*** | -0.348\*** | -1.139\*** |
| price × crop         |  1.200\*   |  0.998     |   3.919\** |
| price × frac         |  0.843\*** |  1.110\*** |  2.943\*** |
| price × crop × frac  | -4.198\**  | -4.071\**  | -8.842\**  |
| price × crop × pola  |  1.309\**  | -1.236\**  |  0.950     |
...
*pola* $=\sum_i\sum_j \pi_i^2\pi_j\eta_{ij}$, where $\eta_{ij}$ is the cropland proportion distance.
...
# Growing-season rainfall amplifies the effect
...
| Conflict type               | Unrest     | Protests   | Riots      |
|:--------------------------- | ----------:| ----------:| ----------:|
| price × crop × rain         | -0.681\*** | -0.376\*** | -0.790\*** |
| price × crop × frac × rain  |  1.309\*** |  0.934\*** |  1.334\*** |
| price × crop × pola × rain  | -0.205     | -0.215\*   | -0.149     |


*rain* is rainfall calculated as monthly deviations from long-run average values, averaged over the crop-growing season months. 
