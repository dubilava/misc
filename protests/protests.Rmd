...
*G* $=\sum_i\sum_j \pi_i\pi_j\delta_{ij}$, where $\delta_{ij}=|area_i-area_j|$ is a "distance" measure of maize production inequality across ethnic boundaries.
...
|:------------------- | ----------:| ----------:| -----------:|
| PRICE               | -0.918\*** | -0.197     | -0.457\**   |
| PRICE × A           |  0.097     |  0.213     | -0.004      |
| PRICE × G           |  0.303     |  0.238     |  0.844\*    |
| PRICE × AGEMP       |  0.144\*** | -0.291\*** | -0.250\***  |
| PRICE × A × AGEMP   |  0.079     | -0.063     | -0.017      |
| PRICE × G × AGEMP   | -0.340\**  |  0.361\*** |  0.213\**   |
